...
- **Deployment adapters auto-detect strategy.** Vercel, Netlify, and Cloudflare adapters configure functions only when the strategy needs them — no manual config required.
...
<Cards>
  <Card
    title="Deployment"
    description="Platform-specific guides for Vercel, Netlify, Cloudflare, and Node.js."
    icon="rocket"
